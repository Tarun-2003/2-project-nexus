        ...
        <div className="modal-dialog" role="document">
          <div className="modal-content rounded-4 shadow">
            <div className="modal-header p-5 pb-4 border-bottom-0 ">
              <h1 id="signup" className="fw-bold mb-0 fs-2">Sign up</h1>
            ...
            <div className="modal-body p-5 pt-0">
              ...
              <div className="form-floating mb-3">
                ...
                <input onChange={(e)=>setName(e.target.value)} type="text" className="form-control rounded-3" id="floatingInput" placeholder="John" required />
                ...
                <div className="form-floating mb-3">
                  <input onChange={(e)=>setPassword(e.target.value)} type="password" className="form-control rounded-3" id="floatingPassword" placeholder="Password" required/>
                  <label htmlFor="floatingPassword" required>Confirm Password</label>
                </div>
                <button className="w-100 mb-2 btn btn-lg rounded-3 btn-dark" type="submit">Register</button>
                </form>
                <Link to="/login"><button className="w-100 mb-2 btn btn-lg rounded-3 btn-dark" type="submit">Login</button></Link>
